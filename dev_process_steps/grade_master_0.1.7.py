...
#             data_dict[id]['midterm_grade_min'] = midterm_min
    ...
    for id in id_list:
        if data_dict[id]['grade_total'] > 95:
            data_dict[id]['letter_grade'] = 'A'
        elif data_dict[id]['grade_total'] > 90:
            data_dict[id]['letter_grade'] = 'A-'
        elif data_dict[id]['grade_total'] > 85:
            data_dict[id]['letter_grade'] = 'B+'
        elif data_dict[id]['grade_total'] > 80:
            data_dict[id]['letter_grade'] = 'B'
        elif data_dict[id]['grade_total'] > 75:
            data_dict[id]['letter_grade'] = 'B-'
        elif data_dict[id]['grade_total'] > 70:
            data_dict[id]['letter_grade'] = 'C+'
        elif data_dict[id]['grade_total'] > 65:
            data_dict[id]['letter_grade'] = 'C'
        elif data_dict[id]['grade_total'] > 60:
            data_dict[id]['letter_grade'] = 'C-'
        elif data_dict[id]['grade_total'] > 55:
            data_dict[id]['letter_grade'] = 'D+'
        elif data_dict[id]['grade_total'] > 50:
            data_dict[id]['letter_grade'] = 'D'
        else:
